angular.module("demo", ["ngRoute", "dndLists", "angular-underscore", 'multipleSelection'])
    .config(function($routeProvider) {
        $routeProvider
            ...
            .when('/multi2', {
                templateUrl: 'multi2/multi-frame.html',
                controller: 'MultiDemoController2'
            })
        ...
        return {
            ...
            link: function (scope, element, attr) {
                scope.options = [
                    ...
                    {label: "Multiselection2", href: "#/multi2"},
